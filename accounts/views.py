...
class SignUpView(generic.CreateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        # перенаправит на домашнюю страницу, если пользователь попытается получить доступ к странице
        # регистрации после авторизации
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.success(request, f'Создан пользователь {username}')
